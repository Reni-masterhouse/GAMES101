                                ...
                                const std::array<int, 3>& dirIsNeg) const
{
    ...
    Vector3f t_min;
    Vector3f t_max;
    t_min.x = (pMin.x - ray.origin.x);
    t_max.x = (pMax.x - ray.origin.x);
    t_min.y = (pMin.y - ray.origin.y);
    t_max.y = (pMax.y - ray.origin.y);
    t_min.z = (pMin.z - ray.origin.z);
    t_max.z = (pMax.z - ray.origin.z);
    if (dirIsNeg[0])
    {
